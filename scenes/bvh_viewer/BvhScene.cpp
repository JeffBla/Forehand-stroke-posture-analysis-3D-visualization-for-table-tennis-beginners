...
void BvhScene::initBodiesPositions() {
    // For each ragdoll
...
void BvhScene::createRagdolls() {
    ...
    for (int i = 0; i < NB_RAGDOLLS_ROWS; i++) {
        for (int j = 0; j < NB_RAGDOLLS_COLS; j++) {
            ...
            rp3d::Vector3 ragdollPosition((-(NB_RAGDOLLS_ROWS - 1) / 2.0 + i) * ragdollDistX, ragdollHeight,
                                          -6 + (-(NB_RAGDOLLS_COLS - 1) / 2.0 + j) * ragdollDistZ);
            ...
            mHipCapsule[ragdollIndex]->setTransform(rp3d::Transform(mHipPos[ragdollIndex],
            ...
            mWaistCapsule[ragdollIndex]->setTransform(
                    rp3d::Transform(mWaistPos[ragdollIndex], rp3d::Quaternion::identity()));
            ...
            mChestCapsule[ragdollIndex]->setTransform(rp3d::Transform(mChestPos[ragdollIndex],
                                                                      rp3d::Quaternion::fromEulerAngles(0, 0,
                                                                                                        rp3d::PI_RP3D /
                                                                                                        2.0)));
            ...
            mLeftUpperArmCapsule[ragdollIndex] = new Capsule(true, 0.5, 2, mPhysicsCommon, mPhysicsWorld,
                                                             mMeshFolderPath);
            mLeftUpperArmCapsule[ragdollIndex]->setTransform(rp3d::Transform(mLeftUpperArmPos[ragdollIndex],
                                                                             rp3d::Quaternion::fromEulerAngles(0, 0,
                                                                                                               rp3d::PI_RP3D /
                                                                                                               2.0)));
            ...
            mLeftLowerArmCapsule[ragdollIndex] = new Capsule(true, 0.5, 2, mPhysicsCommon, mPhysicsWorld,
                                                             mMeshFolderPath);
            mLeftLowerArmCapsule[ragdollIndex]->setTransform(rp3d::Transform(mLeftLowerArmPos[ragdollIndex],
                                                                             rp3d::Quaternion::fromEulerAngles(0, 0,
                                                                                                               rp3d::PI_RP3D /
                                                                                                               2.0)));
            ...
            mLeftUpperLegCapsule[ragdollIndex] = new Capsule(true, 0.75, 2, mPhysicsCommon, mPhysicsWorld,
                                                             mMeshFolderPath);
            mLeftUpperLegCapsule[ragdollIndex]->setTransform(
                    rp3d::Transform(mLeftUpperLegPos[ragdollIndex], rp3d::Quaternion::identity()));
            ...
            mLeftLowerLegCapsule[ragdollIndex] = new Capsule(true, 0.5, 3, mPhysicsCommon, mPhysicsWorld,
                                                             mMeshFolderPath);
            mLeftLowerLegCapsule[ragdollIndex]->setTransform(
                    rp3d::Transform(mLeftLowerLegPos[ragdollIndex], rp3d::Quaternion::identity()));
            ...
            mRightUpperArmCapsule[ragdollIndex] = new Capsule(true, 0.5, 2, mPhysicsCommon, mPhysicsWorld,
                                                              mMeshFolderPath);
            mRightUpperArmCapsule[ragdollIndex]->setTransform(rp3d::Transform(mRightUpperArmPos[ragdollIndex],
                                                                              rp3d::Quaternion::fromEulerAngles(0, 0,
                                                                                                                rp3d::PI_RP3D /
                                                                                                                2.0)));
            ...
            mRightLowerArmCapsule[ragdollIndex] = new Capsule(true, 0.5, 2, mPhysicsCommon, mPhysicsWorld,
                                                              mMeshFolderPath);
            mRightLowerArmCapsule[ragdollIndex]->setTransform(rp3d::Transform(mRightLowerArmPos[ragdollIndex],
                                                                              rp3d::Quaternion::fromEulerAngles(0, 0,
                                                                                                                rp3d::PI_RP3D /
                                                                                                                2.0)));
            ...
            mRightUpperLegCapsule[ragdollIndex] = new Capsule(true, 0.75, 2, mPhysicsCommon, mPhysicsWorld,
                                                              mMeshFolderPath);
            mRightUpperLegCapsule[ragdollIndex]->setTransform(
                    rp3d::Transform(mRightUpperLegPos[ragdollIndex], rp3d::Quaternion::identity()));
            ...
            mRightLowerLegCapsule[ragdollIndex] = new Capsule(true, 0.5, 3, mPhysicsCommon, mPhysicsWorld,
                                                              mMeshFolderPath);
            mRightLowerLegCapsule[ragdollIndex]->setTransform(
                    rp3d::Transform(mRightLowerLegPos[ragdollIndex], rp3d::Quaternion::identity()));
            ...
            mHeadChestJoint[ragdollIndex] = dynamic_cast<rp3d::BallAndSocketJoint *>(mPhysicsWorld->createJoint(
                    jointInfo1));
            ...
            rp3d::BallAndSocketJointInfo jointInfo2(body1, body2,
                                                    mLeftUpperArmPos[ragdollIndex] + rp3d::Vector3(-1, 0, 0));
            jointInfo2.isCollisionEnabled = false;
            mChestLeftUpperArmJoint[ragdollIndex] = dynamic_cast<rp3d::BallAndSocketJoint *>(mPhysicsWorld->createJoint(
                    jointInfo2));
            ...
            mLeftUpperLeftLowerArmJoint[ragdollIndex] = dynamic_cast<rp3d::HingeJoint *>(mPhysicsWorld->createJoint(
                    jointInfo3));
            ...
            mChestWaistJoint[ragdollIndex] = dynamic_cast<rp3d::FixedJoint *>(mPhysicsWorld->createJoint(
                    jointChestWaistInfo));
            ...
            mWaistHipsJoint[ragdollIndex] = dynamic_cast<rp3d::FixedJoint *>(mPhysicsWorld->createJoint(
                    jointWaistHipsInfo));
            ...
            mHipLeftUpperLegJoint[ragdollIndex] = dynamic_cast<rp3d::BallAndSocketJoint *>(mPhysicsWorld->createJoint(
                    jointInfo4));
            ...
            rp3d::HingeJointInfo jointInfo5(body1, body2, joint5WorldAnchor, joint5WorldAxis, joint5MinAngle,
                                            joint5MaxAngle);
            jointInfo5.isCollisionEnabled = false;
            mLeftUpperLeftLowerLegJoint[ragdollIndex] = dynamic_cast<rp3d::HingeJoint *>(mPhysicsWorld->createJoint(
                    jointInfo5));
            ...
            rp3d::BallAndSocketJointInfo jointInfo6(body1, body2,
                                                    mRightUpperArmPos[ragdollIndex] + rp3d::Vector3(1, 0, 0));
            jointInfo6.isCollisionEnabled = false;
            mChestRightUpperArmJoint[ragdollIndex] = dynamic_cast<rp3d::BallAndSocketJoint *>(mPhysicsWorld->createJoint(
                    jointInfo6));
            ...
            mRightUpperRightLowerArmJoint[ragdollIndex] = dynamic_cast<rp3d::HingeJoint *>(mPhysicsWorld->createJoint(
                    jointInfo7));
            ...
            mHipRightUpperLegJoint[ragdollIndex] = dynamic_cast<rp3d::BallAndSocketJoint *>(mPhysicsWorld->createJoint(
                    jointInfo8));
            ...
            mRightUpperRightLowerLegJoint[ragdollIndex] = dynamic_cast<rp3d::HingeJoint *>(mPhysicsWorld->createJoint(
                    jointInfo9));
        }
    }
}
